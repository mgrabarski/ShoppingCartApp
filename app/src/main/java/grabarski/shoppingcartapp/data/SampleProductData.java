package grabarski.shoppingcartapp.data;
...
public class SampleProductData {
    ...
    public static List<Product> getSampleProducts() {
        ...
        product1.setProductDescription("Great for printing UPS WorldShip shipping labels with a fixed media width. Compact enough for use at home or in office.");
        ...
        product2.setProductDescription("A&D Products Compatible Toner Cartridge Replacement for HP CE255X is the affordable alternative to OEM product.");
        ...
        product3.setProductDescription("Buddy Products is committed to providing quality products at competitive prices. Keep your valuables protected and secure in your home or office.");
        ...
        product4.setProductDescription("Multipurpose organizer: office desktop file sorter for mail, letter, folders, envelopes; upscale look");
        ...
        product5.setProductDescription("High-accuracy readings for hefty weights: Capacity: 110lb/50kg, Graduation: 0.1lb/50g");
        ...
        product6.setProductDescription("Print wirelessly and effortlessly from your compatible iPhone, iPad, or iPod touch- no drivers needed!");
        ...
        product7.setProductDescription("Two temperature settings for laminating 3 mil and 5 mil pouches with professional quality finish");
        ...
        product8.setProductDescription("Affordable, With chip and ink(Non-OEM),work with all new printers. Show accurate ink levels.");
        ...
        product9.setProductDescription("SIMPLE AND EASY TO USE AND CHARGE Single ON/OFF switch for hassle-free operation as a spy USB recorder.");
        ...
        product10.setProductDescription("Laminates items up to 9 inches wide. The TL901 is designed to be used in a home or small office environment");
        ...
        product11.setProductDescription("Slim sleek stand elevates your CPU for easier access, Adjustable to accommodate most CPUs");
        ...
        product12.setProductDescription("Slim sleek stand elevates your CPU for easier access, Adjustable to accommodate most CPUs");
